...
## Corpus Check
- 386 files · ~386,888 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2648 nodes · 4978 edges · 244 communities (181 shown, 63 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 102 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `15b4deb1`
...
- `POST()` --indirect_call--> `err()`  [INFERRED]
  app/api/internal/n8n/outbound-jobs/claim/route.ts → lib/channel-sender.ts
...
Cohesion: 0.05
Nodes (75): AmbientBackground(), CARD_LAYOUT, CardShell(), CommsCards(), CommsCardsProps, CommsCardsStatic(), chartPoints, DashboardPreview() (+67 more)

### Community 1 - "Social Posts UI & Data"
Cohesion: 0.14
Nodes (16): BrandAssetPicker(), BrandAssetPickerProps, BrandAssetThumb(), Composer(), ComposerProps, Step, CreateWithAiPath(), CreateWithAiPathProps (+8 more)
...
Cohesion: 0.08
Nodes (37): absoluteRedirect(), defaultGmailCallbackDeps, errorRedirect(), GmailCallbackDeps, GoogleTokenResponse, GoogleUserInfo, handleGmailOAuthCallback(), logStageError() (+29 more)
...
Cohesion: 0.25
Nodes (17): appUrl(), exchangeCode(), GET(), settingsRedirect(), TokenResult, GET(), decodeState(), encodeState() (+9 more)
...
Cohesion: 0.16
Nodes (19): ExtractedMessage, extractMessages(), verifyMetaSignature(), WebhookPlatform, GET(), POST(), constantTimeEqual(), recordInboundEvents() (+11 more)
...
Cohesion: 0.19
Nodes (14): GET(), decodeOAuthState(), encodeOAuthState(), isMetaPlatform(), isUuid(), META_PLATFORMS, META_SCOPES, metaConfigError() (+6 more)

### Community 18 - "Layout & Sidebar Components"
Cohesion: 0.12
Nodes (19): appNav, isNavActive(), SidebarBrand(), SidebarChrome(), SidebarFooter(), SidebarHeader(), SidebarNav(), marketingLinks (+11 more)
...
Cohesion: 0.14
Nodes (21): CaptionSectionProps, captionExcerpt(), PostCard(), Filter, PostStatusBoard(), PostStatusBoardProps, ReviewSubmitProps, PLATFORM_ICONS (+13 more)
...
Cohesion: 0.17
Nodes (24): ApprovalBody, approvalWebhookUrl(), PATCH(), POST(), POST(), POST(), POST(), POST() (+16 more)
...
Cohesion: 0.16
Nodes (16): ReviewSubmit(), CopyLinkButton(), InviteManager(), STATUS_STYLES, StatusPill(), useOrganization(), buildInviteLink(), createInvite() (+8 more)
...
Cohesion: 0.47
Nodes (5): boundedString(), CONVERSATION_SOURCES, pickAllowed(), POST(), POST_STATUSES

### Community 28 - "Posts Workspace Components"
Cohesion: 0.18
Nodes (14): UploadMediaPathProps, buildStoragePath(), captionsFromText(), createPost(), deletePost(), extensionOf(), schedulePost(), unschedulePost() (+6 more)
...
Cohesion: 0.33
Nodes (5): PostsWorkspace(), View, resolveOrganizationIdForUser(), trimmedUuid(), useOrganizationId()
...
### Community 43 - "Api"
Cohesion: 0.15
Nodes (16): SettingsSection(), SettingsSectionProps, META_LABELS, planPricingCopy(), planTitle(), SettingsView(), SOCIAL_ICONS, StatusPill() (+8 more)
...
Cohesion: 0.15
Nodes (20): Body, POST(), testImap(), CredentialRow, GET(), MetaDebugTokenResponse, refreshPageAccessToken(), tokenNeedsRefresh() (+12 more)
...
### Community 82 - "Route"
Cohesion: 0.31
Nodes (7): ConfirmPublishDialog(), defaultLocalDateTime(), ScheduleDialog(), Busy, Spinner(), SpinnerProps, PLATFORM_LABELS
...
Cohesion: 0.19
Nodes (13): AutopilotInput, BusinessProfileRow, ConversationRow, deriveSubject(), DraftRow, executeSendReply(), finalizeOutboundJob(), LeadRow (+5 more)
...
Cohesion: 0.23
Nodes (10): buildMetaSendRequest(), GraphSendResponse, graphUrl(), isMetaSendEnabled(), MetaSendAuth, MetaSendError, MetaSendParams, MetaSendRequest (+2 more)

### Community 119 - "Seed Demo Data"
Cohesion: 0.09
Nodes (39): GET(), GET(), UsageRow, DELETE(), GET(), POST(), safeFileName(), GET() (+31 more)
...
Cohesion: 0.13
Nodes (21): buildUserPayload(), ClassificationResult, classifyMessage(), ClassifyMessageParams, ClassifyMessageResponse, MOCK_CLASSIFICATION, parseClassification(), buildUserPayload() (+13 more)
...
Cohesion: 0.27
Nodes (12): Busy, CaptionSection(), listConnectedPlatforms(), PostCaptions, editImage(), enhanceCaption(), generateCaptions(), GenerateImageResult (+4 more)

### Community 210 - "Badge.tsx"
Cohesion: 0.15
Nodes (21): MessageRow, sessionTitle(), summarizeSession(), AI_MODELS, AiOperation, clientCache, ClientPurpose, getOpenAiClient() (+13 more)
...
Cohesion: 0.08
Nodes (46): POST(), defaultGmailSyncDeps, GmailSyncDeps, runGmailSync(), SyncCredentialRow, WorkspaceSyncOutcome, POST(), boundedString() (+38 more)

### Community 218 - "store.ts"
Cohesion: 0.26
Nodes (14): embedBatch(), embedText(), mockVector(), resolveModel(), chunkText(), deleteSummaryForSource(), EmbeddingKind, KIND_WEIGHTS (+6 more)
...
Cohesion: 0.19
Nodes (13): AppChromeSearchContext, AppChromeSearchContextValue, AppChromeSearchProvider(), useAppChromeSearch(), AppShell(), AUTH_ONLY_PREFIXES, isAuthShellRoute(), isMarketingShellRoute() (+5 more)

### Community 221 - "api.ts"
Cohesion: 0.14
Nodes (11): SessionGate(), approveReply(), errorFromResponse(), normalizeWebhookPath(), parseJsonSafe(), rejectReply(), requestJson(), resolveFetchUrl() (+3 more)

### Community 222 - "route.ts"
Cohesion: 0.24
Nodes (15): absoluteRedirect(), errorRedirect(), exchangeCodeForToken(), exchangeLongLivedToken(), fetchPageAccounts(), fetchWaPhoneNumberId(), GET(), MetaPageAccount (+7 more)
...
Cohesion: 0.21
Nodes (10): ChatMessage, ChatPage(), ChatRole, decodeSourcesHeader(), KnowledgeSource, SOURCE_KIND_LABEL, SUGGESTIONS, useAiStatus() (+2 more)
...
Cohesion: 0.27
Nodes (6): chooseSendStrategy(), msSinceLastInbound(), StrategyInput, withinServiceWindow(), NOW, pending
...
## Knowledge Gaps
- **977 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `UsageRow`, `ApprovalBody`, `ExistingUser` (+972 more)
