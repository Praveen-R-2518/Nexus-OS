# Graph Report - Nexus-OS  (2026-07-17)

## Corpus Check
- 386 files · ~385,815 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2643 nodes · 4971 edges · 242 communities (180 shown, 62 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 102 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ad2e8597`
...
1. `cn()` - 93 edges
2. `rateLimit()` - 79 edges
3. `readJsonObjectWithLimit()` - 66 edges
4. `createServerClient()` - 62 edges
5. `scripts` - 53 edges
6. `requireApiTenantContext()` - 44 edges
7. `createSupabaseBrowserClient()` - 41 edges
8. `jsonError()` - 40 edges
9. `JSON_LIMITS` - 33 edges
10. `rateLimitDurable()` - 33 edges
...
Cohesion: 0.06
Nodes (53): AmbientBackground(), CARD_LAYOUT, CardShell(), CommsCards(), CommsCardsProps, CommsCardsStatic(), chartPoints, DashboardPreview() (+45 more)

### Community 1 - "Social Posts UI & Data"
Cohesion: 0.15
Nodes (21): BrandAssetPicker(), BrandAssetPickerProps, BrandAssetThumb(), CreateWithAiPathProps, CurrentGen, buildStoragePath(), captionsFromText(), deleteBrandAsset() (+13 more)

### Community 2 - "Package Dependencies"
Cohesion: 0.04
Nodes (53): scripts, build, check:auth-email, check:signup-backend, dev, fix:auth-email, lint, n8n:export-workflows (+45 more)
...
Cohesion: 0.08
Nodes (21): caseStudies, CaseStudy, logos, stats, styleScript, testimonials, DocLink, DocSection (+13 more)

### Community 8 - "Signup Wizard"
Cohesion: 0.16
Nodes (16): defaultGmailSyncDeps, GmailSyncDeps, SyncCredentialRow, WorkspaceSyncOutcome, decodeBase64Url(), extractPlainText(), formatGmailAfterQuery(), GmailIntakePayload (+8 more)
...
Cohesion: 0.08
Nodes (30): AssistantBody(), ChatMessage, ChatPage(), ChatRole, decodeSourcesHeader(), KnowledgeSource, SOURCE_KIND_LABEL, SUGGESTIONS (+22 more)
...
Cohesion: 0.14
Nodes (15): BillingToggle(), BillingToggleProps, PricingFAQ(), PricingTierCard(), PricingTierCardProps, PricingCard(), PricingCardProps, StepPlan() (+7 more)
...
Cohesion: 0.09
Nodes (26): churnDraftTag(), DashboardPage(), hotLeadDraftTag(), isDraftPipelineReady(), TIMESERIES_RANGES, urgencyBadgeLabel(), ZERO_METRICS, formatAxisValue() (+18 more)
...
Cohesion: 0.09
Nodes (44): absoluteRedirect(), errorRedirect(), exchangeCodeForToken(), exchangeLongLivedToken(), fetchPageAccounts(), fetchWaPhoneNumberId(), GET(), MetaPageAccount (+36 more)

### Community 18 - "Layout & Sidebar Components"
Cohesion: 0.11
Nodes (22): MiniCard(), appNav, isNavActive(), SidebarBrand(), SidebarChrome(), SidebarFooter(), SidebarHeader(), SidebarNav() (+14 more)
...
Cohesion: 0.18
Nodes (15): CaptionSectionProps, captionExcerpt(), PostCard(), Filter, PostStatusBoard(), PostStatusBoardProps, ReviewSubmitProps, PLATFORM_ICONS (+7 more)

### Community 21 - "Chat Analyst Agent"
Cohesion: 0.18
Nodes (15): aggregateSnapshot(), AnalystSnapshot, buildAnalystContext(), BusinessRow, ConversationRow, DraftRow, emptySnapshot(), IntentLabel (+7 more)

### Community 22 - "Dashboard Texture Canvas"
Cohesion: 0.22
Nodes (18): POST(), POST(), POST(), POST(), POST(), POST(), JSON_LIMITS, readJsonObjectWithLimit() (+10 more)
...
Cohesion: 0.15
Nodes (18): ApprovalFilter, ApprovalPage(), DraftItem, fallbackConversation(), FILTERS, intentLabel(), mergeDraftsWithConversations(), SORT_WEIGHT (+10 more)
...
Cohesion: 0.10
Nodes (26): isValidEmail(), normalizeEmail(), POST(), boundedString(), CONVERSATION_SOURCES, pickAllowed(), POST(), POST_STATUSES (+18 more)
...
### Community 30 - "Page"
Cohesion: 0.22
Nodes (18): ChatUsageToolbar(), formatTokens(), VisualToggle(), authenticatedFetch(), aiUsageQuery(), conversationsQuery(), dailyReportQuery(), enhancePersona() (+10 more)
...
### Community 33 - "Route"
Cohesion: 0.12
Nodes (20): actionTaken(), AiUsageCard(), csvEscape(), formatReportDate(), formatTokens(), isSameReportDay(), labelize(), ReportPage() (+12 more)
...
Cohesion: 0.15
Nodes (16): CaptionSection(), Composer(), ComposerProps, Step, CreateWithAiPath(), PostsWorkspace(), View, ReviewSubmit() (+8 more)
...
Cohesion: 0.04
Nodes (45): clsx, date-fns, dotenv, framer-motion, imap, lucide-react, next, next-themes (+37 more)

### Community 43 - "Api"
Cohesion: 0.14
Nodes (18): SettingsSection(), SettingsSectionProps, META_LABELS, planPricingCopy(), planTitle(), SettingsView(), SOCIAL_ICONS, useCallbackStatusBanner() (+10 more)
...
Cohesion: 0.22
Nodes (13): AppearanceSettings(), ThemeToggle(), applyFontScaleToDocument(), FONT_SCALE_OPTIONS, FontScale, getAlternateTheme(), isFontScale(), isThemeId() (+5 more)
...
### Community 53 - "Badge"
Cohesion: 0.21
Nodes (12): GET(), isRateLimitError(), AuthLikeError, isRateLimitError(), LoginForm(), PASSWORD_BACKOFF_SECONDS, resolvePostLoginPath(), SessionLike (+4 more)
...
Cohesion: 0.29
Nodes (5): COMPANY_SIZES, LaunchWorkspaceResponse, StepWorkspace(), StepWorkspaceProps, WorkspaceType
...
Cohesion: 0.13
Nodes (23): Body, POST(), testImap(), GET(), refreshAccessToken(), tokenNeedsRefresh(), decryptSecret(), deriveKey() (+15 more)
...
### Community 82 - "Route"
Cohesion: 0.21
Nodes (11): ConfirmPublishDialog(), defaultLocalDateTime(), ScheduleDialog(), Busy, Spinner(), SpinnerProps, deletePost(), schedulePost() (+3 more)
...
Cohesion: 0.13
Nodes (20): AutopilotInput, autopilotSend(), BusinessProfileRow, ConversationRow, deriveSubject(), DraftRow, err(), executeSendReply() (+12 more)
...
Cohesion: 0.26
Nodes (13): hasSignupProgress(), SignupPage(), STEP_FROM_PARAM, STEP_LABELS, stepFromParam(), defaultSignupSnapshot(), LEGACY_SIGNUP_STORAGE_KEYS, loadSignupSnapshot() (+5 more)

### Community 97 - "Package"
Cohesion: 0.12
Nodes (39): boundedString(), POST(), boundedString(), normalizeClassification(), POST(), POST(), boundedString(), optionalTokenCount() (+31 more)
...
Cohesion: 0.13
Nodes (18): ResolvedMetaCredential, buildMetaSendRequest(), GraphSendResponse, graphUrl(), isMetaSendEnabled(), MetaSendAuth, MetaSendError, MetaSendParams (+10 more)

### Community 119 - "Seed Demo Data"
Cohesion: 0.13
Nodes (30): GET(), GET(), UsageRow, DELETE(), GET(), POST(), safeFileName(), GET() (+22 more)
...
Cohesion: 0.16
Nodes (19): buildUserPayload(), draftReply(), DraftReplyParams, DraftReplyResponse, MOCK_DRAFT, parseDraft(), ReplyDraftResult, SimilarContextChunk (+11 more)
...
Cohesion: 0.16
Nodes (15): formatTimestamp(), LogsPage(), RESULT_FILTERS, resultTone(), readSessionContext(), TenantScopeContext, TenantScopeGate(), TenantScopeValue (+7 more)
...
Cohesion: 0.22
Nodes (8): GMAIL_ERROR_MESSAGES, StepGmail(), StepGmailProps, planTitle(), StepPayment(), StepPaymentProps, SignupSnapshot, STARTER_TRIAL_INCLUDES
...
Cohesion: 0.60
Nodes (4): planLabel(), StepDone(), StepDoneProps, clearSignupSnapshot()
...
Cohesion: 0.20
Nodes (16): SocialOAuthState, Busy, createPost(), listConnectedPlatforms(), PostDraftInput, PostEditInput, Platform, PostCaptions (+8 more)

### Community 210 - "Badge.tsx"
Cohesion: 0.16
Nodes (17): summarizeSession(), buildUserPayload(), ClassificationResult, classifyMessage(), ClassifyMessageParams, ClassifyMessageResponse, MOCK_CLASSIFICATION, parseClassification() (+9 more)
...
Cohesion: 0.18
Nodes (20): applyChannelPatch(), APPROVAL_MODES, billingPeriodBounds(), CHANNEL_ACTIONS, CHANNEL_TARGETS, ChannelPatch, COMMON_TIMEZONES, GET() (+12 more)
...
Cohesion: 0.24
Nodes (15): isMockMode(), embedBatch(), embedText(), mockVector(), resolveModel(), chunkText(), deleteSummaryForSource(), EmbeddingKind (+7 more)
...
Cohesion: 0.23
Nodes (9): SessionGate(), AppShell(), AUTH_ONLY_PREFIXES, isAuthShellRoute(), isMarketingShellRoute(), MARKETING_PREFIXES, SiteFooter(), SessionRouter (+1 more)

### Community 221 - "api.ts"
Cohesion: 0.22
...
Cohesion: 0.29
Nodes (10): POST(), fetchGmailMessage(), backfillAfterDate(), claimGmailBackfillJob(), enqueueGmailBackfillJob(), GmailBackfillJob, GmailBackfillJobStatus, updateGmailBackfillJobProgress() (+2 more)

### Community 223 - "layout.tsx"
Cohesion: 0.22
Nodes (7): geistMono, geistSans, inter, metadata, sourceSans3, QueryProvider(), ThemeProvider()

### Community 224 - "system-prompt.ts"
Cohesion: 0.27
Nodes (9): AnalystContext, BusinessContext, buildAnalystSystemPrompt(), formatBusiness(), formatKnowledge(), formatSnapshot(), RULES, chartPromptAddendum() (+1 more)
...
Cohesion: 0.31
Nodes (8): boundedString(), INTENTS, NEXT_ACTIONS, numberOr(), pickAllowed(), POST(), RISK_TYPES, URGENCIES

### Community 230 - "credentials.ts"
Cohesion: 0.28
...
Cohesion: 0.39
Nodes (6): ApprovalBody, approvalWebhookUrl(), PATCH(), POST(), publishWebhookUrl(), n8nWebhookAuthHeaders()

### Community 234 - "e2e_live_hop.ts"
Cohesion: 0.32
...
### Community 236 - "createSupabaseRouteHandlerClient"
Cohesion: 0.52
Nodes (4): GET(), GET(), requireApiUser(), createSupabaseRouteHandlerClient()
...
## Knowledge Gaps
- **974 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `UsageRow`, `ApprovalBody`, `ExistingUser` (+969 more)
...
- **Why does `cn()` connect `Layout & Sidebar Components` to `Landing Hero & 3D Scroll`, `Social Posts UI & Data`, `n8n Internal Ingest APIs`, `Pricing & Plans`, `API Security Limits`, `Tenant API Context & Types`, `Team Invites`, `Approval Queue Page`, `Inbox & Deep Links`, `Page`, `Route`, `Webhooks`, `Api`, `Fetchers`, `handler.ts`, `route.ts`, `route.ts`, `webhooks.ts`, `Route`, `AppShell.tsx`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `testImap()` connect `Seed Demo Inbox` to `Package`, `Package`?**
...
- **Should `Landing Hero & 3D Scroll` be split into smaller, more focused modules?**
