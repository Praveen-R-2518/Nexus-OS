-- Ensure every signup creates a business_profiles row for Gmail routing and WF0a tenant resolution.
...
comment on function public.launch_workspace(text, text[], text, text, text) is
  'Retry-safe first-time workspace bootstrap and repair: team, profile.team_id, workspace, business_profiles, owner member, optional invitations.';
