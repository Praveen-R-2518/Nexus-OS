    ...
    <div className="min-h-screen bg-black p-8">
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
          ...
          <p className="text-4xl font-bold text-sky-400 mb-2">{churnRisks}</p>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
          ...
          <p className="text-4xl font-bold text-sky-400 mb-2">{hoursSaved}h</p>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <a href="/inbox" className="text-sky-400 text-sm hover:underline">
              Open inbox →
            </a>
          </div>
                ...
                {leads
                  ...
                  .map((lead) => (
                    <div key={lead.id} className="p-2 bg-gray-800 rounded text-sm">
                      ...
                      <p className="text-sky-400">${lead.estimated_value}</p>
                    </div>
                  ))}
              </div>
            )}
