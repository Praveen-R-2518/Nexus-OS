 ...
 *
 * Prompt files (in ai_prompts/):
 * - Default: classification_prompt.txt (Nexus OS schema: intent_type, lead_score, …)
 * - Member 4 / Silva LKR: set env NEXUS_CLASSIFICATION_PROMPT_FILE=classification_prompt_silva_lkr.txt
 *   → schema: intent, urgency, estimated_value (LKR), risk_type, risk_score, missing_fields, recommended_action, confidence, summary
 *
 * Env:
 ...
 *
 * Output: spreads classifier JSON onto the item plus classification_result.
 */
